...
1. File List: 
	...
	Supplementary_Material.xlsx (with 4 tabs for Supplementary Materials 1, 3-5):	
	...
	Tables1-2.docx					Copy of manuscript Tables 1-2, with details on 
									morphological variables and ecological characteristics
									in Supplementary_Material.xlsx.
	
	SupplementaryMaterial_2.R		R Script that reads	Supplementary_Material.xlsx
